...
//             profile: null
//         }
//         const date = new Date("2020-07-06");
//     }
...
//         axios.put("http://localhost:9000/vet/id" + this.state.profile._id, updatedProfile)
...
//         this.setState({spareField1: newSchedule})
...
//         console.log(week)
//         console.log(this.weeklyTimeBlocks)
//     }
// //    unshift()
...
//                         <ScheduleSelector
//                             // selection={this.state.profile.spareField1}
//                             numDays={7}
//                             startDate={new Date("2020-07-06")}
//                             // startDate:{"Tue Jul 07 2020 06:00:00 GMT-0700 (Pacific Daylight Time)"}
//                             // hourlyChunks={2}
//                             minTime={6}
//                             maxTime={23}
//                             dateFormat={"dddd"}
