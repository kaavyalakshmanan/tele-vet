...
// EFFECTS: Render the profile picture and user data section of the user dashboard
// REQUIRED PROPS: collapsed
...
export default function NavHeader(props) {
    ...
    return (<>
            <div style={{padding: props.collapsed ? 8 : 16, transition: "0.3s"}}>
                <a>
                    <Avatar
                        style={{
                            width: props.collapsed ? 40 : 80,
                            height: props.collapsed ? 40 : 80,
                            transition: "0.3s"
                        }}
                ...
                {getUsernameAndEmail(props.collapsed, user.username, user.email)}
            </div>
            <Divider/>
