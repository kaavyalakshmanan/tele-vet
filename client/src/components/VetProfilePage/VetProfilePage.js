...
// // import Header from "../../material-ui-assets/components/Header/Header"
...
// }));
//
// export default function VetProfilePage({vet, auth}) {
...
//     useEffect(() => {
//         if (auth && currentVet._id) {
//             dispatch(getVetById(currentVet._id));
//         }
//     }, [])
...
//         SetAvailabilitiesOpen(false);
//         myRef.current.handleSubmission(currentVet._id);
//     }
//
